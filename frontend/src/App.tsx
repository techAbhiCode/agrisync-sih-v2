...
const Unauthorized = () => (
  <div className="min-h-screen bg-[#09090b] flex items-center justify-center">
    <div className="text-center">
      ...
      <p className="text-gray-600 text-lg">Unauthorized Access</p>
    </div>
  </div>
);
...
const AdminDashboard = () => (
  <div className="p-8">
    <h1 className="text-3xl font-black text-green-950 mb-2">Mandi <span className="text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-emerald-500">Control Panel</span></h1>
    ...
    <>
      ...
      <Route element={<AppLayout />}>
        ...
        <Route element={<ProtectedRoute allowedRoles={['ADMIN']} />}>
          ...
          <Route path="/admin/inventory" element={<div className="p-8 text-green-800">Inventory Management</div>} />
        </Route>
