    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-400 mt-2 text-sm">Enterprise Agricultural Management</p>
        </div>
        ...
        <Card className="bg-zinc-900/60 backdrop-blur-xl border-zinc-800 shadow-2xl">
          ...
          <CardContent>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-10 bg-zinc-950/50 border-zinc-800 text-white focus-visible:ring-lime-500 transition-all" 
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-xs text-lime-500 hover:text-lime-400 transition-colors">Forgot password?</a>
                </div>
                <div className="relative">
              ...
              <Button 
                type="submit" 
                disabled={isLoading}
                className="w-full mt-6 bg-lime-500 hover:bg-lime-600 text-zinc-950 font-bold h-11 transition-all shadow-[0_0_15px_rgba(132,204,22,0.3)] hover:shadow-[0_0_25px_rgba(132,204,22,0.5)]"
              >
                {isLoading ? (
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-zinc-900/60 px-2 text-zinc-500">Or continue with</span></div>
            </div>
            ...
            <p className="text-center text-xs text-zinc-500 mt-5">
              ...
              <Link to="/register" className="text-lime-500 hover:text-lime-400 font-medium transition-colors">
                Sign up
              </Link>
            </p>
          </CardContent>
